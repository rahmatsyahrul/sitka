...
<div class="container-fluid">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form class="form-inline">
                ...
                <a href="<?= base_url('user/dataAbsensi/inputAbsensi'); ?>" class="btn btn-success mb-2 ml-3"><i class="fas fa-plus"></i> Input Kehadiran</a>
            </form>
        </div>
    </div>
    ...
    ?>
        ...
        <a onclick="return confirm ('yakin hapus data yang sudah ada?')" href="<?= base_url('user/dataAbsensi/delete_data/' . $bulantahun); ?>" class="btn btn-danger" style="margin-bottom: 100px;">Hapus Data</a>
